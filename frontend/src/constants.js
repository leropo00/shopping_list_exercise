...
const URL_UPDATE_PURCHASE_ITEMS = URL_GET_PURCHASE_ITEMS
const URL_DELETE_PURCHASE_ITEMS = URL_GET_PURCHASE_ITEMS
...
export {
  ...
  URL_UPDATE_PURCHASE_ITEMS,
  URL_DELETE_PURCHASE_ITEMS,
  URL_EXPORT_JSON,
  URL_IMPORT_JSON,
}
